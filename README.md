...
## 动机（Motivation）
这是致力于规范元宇宙公共资源的标准，也是一个开放协议。它是“Code is Law”的一次实践，即“Smart Contract is Law”，只要你的智能合约与该技术标准对应的智能合约进行了交互，那就意味着接受了将自己的智能合约及其所有资源定为元宇宙公共资源这一协议。反过来，这一智能合约就成为元宇宙里所有公共资源的检索库。
